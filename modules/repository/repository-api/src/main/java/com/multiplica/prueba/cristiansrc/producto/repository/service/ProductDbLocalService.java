...
/**
 * Provides the local service interface for ProductDb. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProductDbLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProductDbLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.multiplica.prueba.cristiansrc.producto.repository.service.impl.ProductDbLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the product db local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProductDbLocalServiceUtil} if injection and service tracking are not available.
	 */
